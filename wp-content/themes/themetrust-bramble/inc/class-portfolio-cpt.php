...
class Portfolio_CPT {
	...
	public function save( $post_id ) {
		...
		$mydata = sanitize_text_field( $_POST['bramble_page_skills'] );

		// Update the meta field.
		update_post_meta( $post_id, 'bramble_page_skills', $mydata );
	...
	public function render_meta_box_content( $post ) {
		...
		$value = get_post_meta( $post->ID, 'bramble_page_skills', true );

		// Display the form, using the current value.
		echo '<label for="bramble_page_skills">';
		_e( 'Skills', $this->textdomain );
		echo '</label> ';
		echo '<input type="text" id="page_skills" name="bramble_page_skills"';
