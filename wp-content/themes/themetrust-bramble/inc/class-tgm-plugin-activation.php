...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	 ...
	 *
	 * Brambles a way to automatically install and activate plugins from within themes.
	...
	class TGM_Plugin_Activation {
		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				// Bramble a new instance of Plugin_Upgrader.
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		/**
		 * Gathers and renames all of our plugin information to be used by WP_List_Table to bramble our table.
		 *
		 * @since 2.2.0
		 *
		...
		/**
		 * Bramble default columns to display important plugin information
		...
		/**
		 * Bramble default title column along with the action links.
		 *
		 * @since 2.2.0
		 *
		 * @param array $item Array of item data.
		...
		/**
		 * Bramble version information column.
		 *
		 * @since 2.5.0
		 *
		 * @param array $item Array of item data.
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-install' === $this->current_action() || 'tgmpa-bulk-update' === $this->current_action() ) {
				...
				// Bramble a new instance of TGM_Bulk_Installer.
