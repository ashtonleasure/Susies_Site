...
/**
* Class to bramble a custom widget for displaying testimonials
*/
...
class TTrust_Testimonials extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'bramble-testimonials', 'description' => __('Display testimonials.', 'bramble' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_testimonials', // Base ID
			__( 'Bramble Testimonials', 'bramble' ), // Name
			 $widget_ops // Args
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Testimonials', 'bramble' ); ?></label>
