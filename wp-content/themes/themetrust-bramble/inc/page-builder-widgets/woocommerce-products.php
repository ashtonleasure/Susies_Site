...
class TTrust_Products extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'bramble-products', 'description' => __('Display Woocommerce Products.', 'bramble' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_products', // Base ID
			__( 'Bramble Woocommerce Products', 'bramble' ), // Name
			 $widget_ops // Args
	...
	public function widget( $args, $instance ) {
			...
			?>
				...
				<h3 class="so-widget-title"><?php echo $instance['title']; ?></h3>
				<?php } ?>
				<ul>
				<?php
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Products', 'bramble' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('categories'); ?>"><?php _e('Show only certain categories', 'bramble'); ?></label>
		<?php
		...
		<p>
		<label for="<?php echo $this->get_field_id('layout'); ?>"><?php _e('Show Featured', 'bramble'); ?></label>
