...
?>
		...
		<article <?php post_class('small'); ?>>
			...
			<?php if(has_post_thumbnail()) : ?>			
				<a href="<?php the_permalink() ?>" rel="bookmark" class="post-thumb"><?php the_post_thumbnail('bramble_thumb_landscape', array('class' => '', 'alt' => ''.get_the_title().'', 'title' => ''.get_the_title().'')); ?></a>
			<?php endif; ?>
