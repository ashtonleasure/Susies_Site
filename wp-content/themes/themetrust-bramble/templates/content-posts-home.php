...
<?php
	...
	$posts_count        = get_theme_mod( 'bramble_recent_posts_count', 3 );
	$recent_posts_title = get_theme_mod( 'bramble_recent_posts_title', __( 'Recent Posts', 'bramble' ) );
	$blog_page_id       = get_option( 'page_for_posts' );
	$recent_summary     = bramble_clean_and_tag( get_theme_mod( 'bramble_recent_posts_summary' ) );
	$background_image   = esc_url( get_theme_mod( 'bramble_posts_background_image' ) );
